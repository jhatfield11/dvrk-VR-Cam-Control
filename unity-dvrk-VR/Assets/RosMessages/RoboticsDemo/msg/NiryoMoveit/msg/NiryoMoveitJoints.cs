...
namespace RosMessageTypes.NiryoMoveit
{
    public class NiryoMoveitJoints : Message
    {
        ...
        public NiryoMoveitJoints(double joint_00, double joint_01, double joint_02, double joint_03, double joint_04, double joint_05, double joint_06, double joint_07)
        {
